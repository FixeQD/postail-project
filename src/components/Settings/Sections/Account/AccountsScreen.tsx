				...
				{accounts.length === 0 && (
					<motion.div
						{...(animationsEnabled
							...
							: {})}
						className='col-span-full flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-[var(--border-subtle)] bg-[var(--surface-panel)] py-24 text-center transition-all duration-300 hover:border-[var(--border-subtle)] hover:bg-[var(--surface-hover)]'>
						<div className='mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-[var(--surface-panel)] ring-1 ring-[var(--border-subtle)]'>
							<Mail className='h-7 w-7 text-[var(--text-tertiary)]' />
						</div>
						<h3 className='text-lg font-semibold text-[var(--text-primary)]'>
							No accounts connected
						</h3>
						<p className='mx-auto mt-2 mb-7 max-w-sm text-sm text-[var(--text-tertiary)]'>
