...
export const Argon2Setup = ({
	...
	const strengthConfig = {
		strong: { width: 'w-full', color: 'bg-green-400', text: 'text-status-success' },
		medium: { width: 'w-2/3', color: 'bg-amber-400', text: 'text-status-warning' },
		weak: { width: 'w-1/3', color: 'bg-red-400', text: 'text-destructive' },
	}
			...
			<motion.div
				...
				<div className='container mx-auto'>
					<button
						type='button'
						onClick={onBack}
						className='group mb-6 flex items-center gap-2 text-sm font-medium text-[var(--text-tertiary)] transition-colors hover:text-[var(--text-primary)]'>
					...
					<div className='flex items-center gap-3'>
						...
						<div>
							...
							<p className='mt-1 text-sm text-[var(--text-tertiary)] text-[var(--text-secondary)]'>
			...
			<div className='container mx-auto flex-1 px-4 py-8'>
				<motion.div
						...
						<motion.div
							...
							<div className='group relative'>
								<input
									...
									className='w-full rounded-xl bg-[var(--surface-panel)] px-4 py-3 pr-12 text-[var(--text-primary)] placeholder-[var(--text-tertiary)] ring-1 ring-[var(--border-subtle)] transition-all duration-200 focus:bg-[var(--surface-hover)] focus:outline-none'
									style={
										{
								...
								<button
									...
									className='absolute top-1/2 right-3 -translate-y-1/2 rounded-lg p-1 text-[var(--text-secondary)] transition-colors text-[var(--text-tertiary)] hover:text-[var(--text-primary)]'>
									{showPassword ? (
					...
					<motion.div
						...
						className='mt-8 rounded-2xl bg-[var(--surface-panel)] p-5 ring-1 ring-[var(--border-faint)]'>
						<div className='flex items-start gap-3'>
							<div className='mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-status-success/15 ring-1 ring-status-success/30'>
