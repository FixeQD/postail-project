				...
				<div className='container mx-auto'>
					...
					<div className='flex items-center gap-3'>
						<div
							...
							<HardDrive className='h-5 w-5' style={{ color: 'var(--accent-color)' }} />
						</div>
						<div>
					...
					<motion.div
						...
						<div className='space-y-3'>
							...
							<button
								...
								className='group flex w-full items-center gap-4 rounded-2xl border border-white/[0.08] bg-white/[0.03] p-4 text-left transition-all hover:border-white/[0.14] hover:bg-white/[0.06]'>
								<div className='flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-slate-800 ring-1 ring-white/10'>
									<FolderOpen className='h-5 w-5 text-slate-400 transition-colors group-hover:text-slate-200' />
								</div>
