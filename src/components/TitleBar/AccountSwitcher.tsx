			...
			<AnimatePresence>
				{isOpen && (
					<motion.div
						...
						className='absolute top-full right-0 z-[300] mt-1.5 w-52 overflow-hidden rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-glass)] shadow-2xl backdrop-blur-2xl'
