			...
			<AnimatePresence>
				{open && (
					<motion.div
						...
						className='absolute top-8 left-0 z-50 w-52 overflow-hidden rounded-xl border border-[var(--border-faint)] bg-[var(--surface-overlay)] shadow-[0_12px_40px_rgba(0,0,0,0.4)] ring-1 ring-white/5'
